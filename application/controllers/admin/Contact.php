...
class Contact extends Veripay_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('phone2', 'Telefonun son2 hanesi', 'trim|max_length[2]|xss_clean');
        $this->form_validation->set_rules('phone3', 'Telefonun son2 hanesi', 'trim|max_length[2]|xss_clean');
        $this->form_validation->set_rules('phone4', 'Telefon', 'trim|max_length[250]|xss_clean');
        $this->form_validation->set_rules('phone5', 'Fax', 'trim|max_length[250]|xss_clean');
        $this->form_validation->set_rules('phone6', 'Telefon', 'trim|max_length[250]|xss_clean');
        ...
        if ($this->form_validation->run() != false) {
            ...
            $post_data->phone3 = $this->input->post('phone3', true);
            $post_data->phone4 = $this->input->post('phone4', true);
            $post_data->phone5 = $this->input->post('phone5', true);
            $post_data->phone6 = $this->input->post('phone6', true);
