                    ...
                    <div class="card">
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <form class="form" id="infoUpdateLang" method="post">
                                    <div class="form-body">

                                        <input type="hidden" name="id" value="<?php echo $selected_lang->id ?>">
                                        <div class="row mt-2">
                                            <div class="col-md-12">
                                                <label>Dil Adı</label>
                                                <input type="text"  class="form-control"  name="lang_name" value="<?php echo  $selected_lang->lang_name ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text"  class="form-control"  name="lang_short" value="<?php echo  $selected_lang->lang_short ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            foreach($words as $key => $val) { ?>
                                                <div class="col-lg-6 mt-2">
                                                    ...
                                                    <input type="text"  class="form-control"  name="<?php echo $key ?>" value="<?php echo !empty($word->$key) ? $word->$key : ''; ?>">
                                                </div>
                                            <?php } ?>
                                        </div>
