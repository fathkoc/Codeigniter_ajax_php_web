                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                            ...
                                            <form id="infoEditProfileGeneralForm" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div action="<?php echo site_url('admin/Add_images/add_image'); ?>"
                                                    ...
                                                    <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                        ...
                                                        <button type="button" onclick="window.location.href = '<?php echo site_url('yonetim-paneli')?>'" class="btn btn-danger">Çık</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                            ...
                                            <form id="infoEditPassForm" action="post">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                        ...
                                                        <button type="reset" onclick="window.location.href = '<?php echo site_url('yonetim-paneli')?>'" class="btn btn-danger">Çık</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
