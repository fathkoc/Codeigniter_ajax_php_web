                    ...
                    <div class="card">
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <form class="form" id="infoAddSlider" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" id="title" aria-describedby="basic-addon3" name="title">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <label>Alt Başlık</label>
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control"  aria-describedby="basic-addon3" name="titles">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <label>Slogan</label>
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" id="text" aria-describedby="basic-addon3" name="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="link" aria-describedby="basic-addon3" name="link">
                                                </div>
                                            </div>
